  ...
  return (
    <section className="greeting-flex">
      ...
      <div className="greeting-avatar">
        <img
          src="/img/golang-astronaut-avatar.png"
          className="greeting-avatar-edge"
          alt="SongJinfeng"
        />
      </div>
      <h1 className="greeting-hey">
        <Translate>Hey 👋 I'm SongJinfeng</Translate>
      </h1>
      {/* Decorative curve */}
      <div className="greeting-text greeting-relative">
        <div className="greeting-curve">
          {/* viewBox="0 0 625 56" */}
          <svg
            className="greeting-decorative-curve"
            viewBox="0 0 520 70"
            fill="none"
        ...
        <h1 className="greeting-relative greeting-inherit">
          <Translate>DevOps Engineer</Translate>
        </h1>
      </div>
      <h1 className="greeting-interested">
        <Translate>
          🎣 Interested in Cloud Native, Linux, Networking, LLM, Blockchain, and
          many other stuffs.
        </Translate>
      </h1>
    </section>
