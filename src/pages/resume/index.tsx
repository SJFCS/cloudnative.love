    ...
    <Layout title={TITLE} description={DESCRIPTION}>
      <div>
        <section className="greeting-flex">
          <Head />
          {/* text & button */}
          <a href="/宋锦丰_DevOps运维开发-容器运维_18660386849.pdf" rel="noopener noreferrer" target="_blank" className="greeting-resume-button"><Translate>Download Resume</Translate></a>
        </section>
        {/* Cert */}
