      ...
      <div>
        ...
        <section className="grid md:grid-cols-3 gap-4 my-8 max-w-5xl mx-auto">
          <div className="relative shadow-sm md:shadow-2xl">
            ...
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
                ...
                href="https://www.credly.com/badges/02d42601-dfd8-41de-a90b-6e1aba0c716d"
              >
                <Translate>
          ...
          <div className="relative row-span-2 col-span-2 shadow-sm md:shadow-2xl">
            ...
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.credly.com/badges/7f665fcf-c0a4-44e7-8b09-06584280dfc2"
              >
                <Translate>Certified Kubernetes Administrator (CKA)</Translate>
              </a>
            </div>
          </div>
          ...
          <div className="relative shadow-sm md:shadow-2xl">
            ...
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.credly.com/badges/c37a3b97-5438-4c05-a28b-6ea2d6f38905"
              >
                <Translate>
          ...
          <div className="relative row-span-2 col-span-2 shadow-sm md:shadow-2xl">
            ...
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.credly.com/badges/14b87040-30ed-446d-b269-b693a2f0a0d0"
              >
                {" "}
                <Translate>Red Hat Certified Engineer (RHCE)</Translate>
              </a>
            </div>
          </div>
          <div className="relative shadow-sm md:shadow-2xl">
            ...
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.credly.com/badges/46d4a035-24e7-4408-9237-42eba03c64cf"
              >
                <Translate>
          ...
          <div className="relative  shadow-sm md:shadow-2xl">
            ...
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              ...
              >
                <Translate>
                  Alibaba Cloud Certified Associate - DevOps (ACA)
                </Translate>
              </a>
            </div>
          </div>
          <div className="relative  shadow-sm md:shadow-2xl">
            ...
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
                ...
                rel="noopener noreferrer"
              >
                <Translate>H3C Certified Network Engineer (H3CNE)</Translate>
              </a>
            </div>
          </div>
          ...
          <div className="relative shadow-sm md:shadow-2xl">
            ...
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              ...
              >
                <Translate>
                  H3C Certified Network Engineer for Cloud (H3CNE-Cloud)
                </Translate>
              </a>
            </div>
          </div>
          <div className="relative shadow-sm md:shadow-2xl">
            <Zoom>
              <img
                className="rounded object-cover w-full h-full"
                loading="lazy"
                src="/img/cert/2018年山东省职业院校技能大赛 云计算技术与应用赛项 二等奖.webp"
              />
            </Zoom>
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
              ...
              >
                <Translate>
                  2018 Shandong Province Vocational College Cloud Computing
                  Technology and Applications Competition Second Prize
                </Translate>
              </a>
            </div>
          </div>
          ...
          <div className="relative shadow-sm md:shadow-2xl">
            <Zoom>
              <img
                className="rounded object-cover w-full h-full"
                loading="lazy"
                src="/img/cert/云计算大数据讲师认证证书.webp"
              />
            </Zoom>
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
              ...
              >
                <Translate>
                  Cloud computing big data lecturer certification (CETC)
                </Translate>
              </a>
            </div>
          </div>
          ...
          <div className="relative  shadow-sm md:shadow-2xl">
            <Zoom>
              <img
                className="rounded object-cover w-full h-full"
                loading="lazy"
                src="/img/cert/2018年山东省职业院校 云计算大数据行业技能大赛 一等奖.webp"
              />
            </Zoom>
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
              ...
              >
                <Translate>
                  2018 Shandong vocational colleges cloud computing big data
                  industry skills competition first prize
                </Translate>
              </a>
            </div>
          </div>
          ...
          <div className="relative  shadow-sm md:shadow-2xl">
            <Zoom>
              <img
                className="rounded object-cover w-full h-full"
                loading="lazy"
                src="/img/cert/ArgoCD-AKUITY.webp"
              />
            </Zoom>
            <div className="noclick bg-black absolute top-0 left-0 rounded w-full h-full  bg-opacity-30 grid place-items-center opacity-0 hover:opacity-100 transition-opacity duration-200">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.credential.net/d8d99fb8-92b1-4fee-8e71-cd6158277c19#gs.46sctu"
              >
                <Translate>
        ...
        <section className="my-16 max-w-2xl mx-auto">
          <div className="text-4xl font-bold text-center">
            <a
              className="Dbutton text-5xl text-blue-400 hover:text-blue-400"
              href="mailto:song.jinfeng@outlook.com"
            >
              <Translate>Let's Chat</Translate>📨
            </a>
          </div>
          <Comment />
        </section>
