...
python lua shell golang,rust java 学习一下spring架构，我现在了解的远远不够，包括服务发现框架，配置中心框架，熔断降级，native镜像，openterlemtry
...
Database
CI/CD                                   
Service Mesh & Service Proxy & Ingress Gateway
Infrastructure as Code & Automation
  熟练掌握Terraform，CloudFormaction。
Observability
Storage
Security+other
  机器学习  区块链 金融知识和量化交易,混沌工程,机器学习流水线编排
