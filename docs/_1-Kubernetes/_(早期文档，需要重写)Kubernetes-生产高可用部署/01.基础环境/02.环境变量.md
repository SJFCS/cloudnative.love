...
# Service网段，部署前路由不可达，部署后集群内路由可达(kube-proxy 和 ipvs 保证)
SERVICE_CLUSTER_CIDR="172.16.0.0/16"
# Pod 网段，部署前路由不可达，部署后集群内路由可达(flanneld/Calico等网络插件 保证)
CLUSTER_CIDR="192.168.0.0/16"

# kubernetes Service IP (一般是 SERVICE_CLUSTER_CIDR 中第1个IP)
KUBERNETES_SVC_IP="172.16.0.1"
# 集群 DNS 服务 IP (一般是 SERVICE_CLUSTER_CIDR 中第10个IP)
...
#原文链接：https://blog.csdn.net/qq_27706119/article/details/93654330
