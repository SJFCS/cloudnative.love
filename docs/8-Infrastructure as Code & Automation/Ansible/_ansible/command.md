...
从command模块的官方文档[https://docs.ansible.com/ansible/latest/modules/command_module.html](https://docs.ansible.com/ansible/latest/modules/command_module.html)中可以看出，此时使用了大量的playbook剧本做为示例，因此此时有必要去初步了解了Ansible剧本的使用，可以简单的了解一下[Ansible剧本](#Ansible剧本)。
