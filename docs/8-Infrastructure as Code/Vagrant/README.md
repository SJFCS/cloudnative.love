...
如果您想要管理本地或远程虚拟机，或者快速关闭和重建虚拟机以进行开发和测试，那么 Vagrant 可能更加适合。
...
3. 我认为在需要内核级别隔离或一些必须使用虚拟化的场景下应该使用 vagrant，它可以跨平台轻松地创建和分发环境，减少心智负担。
[我应该使用 Vagrant 还是 Docker-Compose 来创建隔离环境？](https://stackoverflow.com/questions/16647069/should-i-use-vagrant-or-docker-for-creating-an-isolated-environment)
